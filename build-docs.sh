#!/usr/bin/env bash
#
# Build and preview the Minefield Test Tools documentation site with DocFX.
#
...
#   3. Open src/Minefield in Unity once so it generates the .sln / .csproj
...
watch_dirs=(
  ...
  "$repo_root/src/Minefield/Assets/Minefield/Documentation~"
  "$repo_root/src/Minefield/Assets/Minefield/CHANGELOG.md"
)
